...
class CastController extends Controller
{
    ...
    {
        $canPlayBoxGame = false;


$canPlayBoxGame = auth()->check()
    && !DB::table('box_game_results')
        ...
        return view('casts.dashboard', compact('casts','user','shopInfo', 'topImages', 'tickers', 'latestNews', 'latestBlogs' ,'canPlayBoxGame'));
    }
