    ...
    <div class="flex h-screen">
        ...
        <aside class="w-64 bg-black text-white p-4 space-y-4">
            <nav class="space-y-2">
                ...
                <a href="/admin/news/create" class="block px-4 py-2 rounded {{ request()->routeIs('admin.news.*') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
                    NEWS投稿
                </a>
